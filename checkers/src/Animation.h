...
void gt_animation_register_at_update(struct gt_animation *a, void (*uf)(double, void *), void *d);
void gt_animation_register_at_end(struct gt_animation *a, void (*f)(void *), void *d);
